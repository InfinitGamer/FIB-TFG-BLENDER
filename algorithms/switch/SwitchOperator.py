...
class SwitchOperator(bpy.types.Operator):
    ...
    bl_description = "Changes between material original and bake from a previous bake process"
    bl_options = {"REGISTER"}
    ...
    def execute(self, context):
        ...
        self.report({'INFO'},f"Models changed to {'baked' if self.switch else 'original'} ones")
        return {'FINISHED'}
